...
CREATE TABLE `v2_plan` (
                           ...
                           `two_year_price` int(11) DEFAULT '0',
                           `three_year_price` int(11) DEFAULT '0',
                           `onetime_price` int(11) DEFAULT '0',
                           `reset_price` int(11) DEFAULT '0',
...
CREATE TABLE `v2_user` (
  ...
  `password_algo` char(40) DEFAULT NULL,
  `password_salt` char(40) DEFAULT NULL,
  `balance` int(11) DEFAULT NULL,
  `commission_type` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0: system 1: cycle 2: onetime',
  `discount` int(11) DEFAULT NULL,
  `commission_rate` int(11) DEFAULT NULL,
  `commission_balance` int(11) DEFAULT NULL,
  `t` int(11) DEFAULT NULL,
  `u` bigint(20) DEFAULT NULL,
  `d` bigint(20) DEFAULT NULL,
  `banned` tinyint(1) NOT NULL DEFAULT '0',
  `is_admin` tinyint(1) DEFAULT NULL DEFAULT '0',
  `last_login_at` int(11) DEFAULT NULL,
  `is_staff` tinyint(1) DEFAULT NULL,
  `last_login_ip` varchar(400) DEFAULT NULL,
  `last_submit_ip` varchar(1020) DEFAULT NULL,
  `register_ip` varchar(400) DEFAULT NULL,
  `uuid` varchar(144) NOT NULL,
  `plan_id` int(11) DEFAULT NULL,
  `remind_expire` tinyint(4) DEFAULT NULL,
  `remind_traffic` tinyint(4) DEFAULT NULL,
  `token` char(128) NOT NULL,
  `order_day` int(11) DEFAULT NULL,
  `expired_at` bigint(20) DEFAULT NULL,
  `suspend_at` int(11) DEFAULT NULL,
  `suspend_type` tinyint(4) DEFAULT NULL,
  `remarks` text,
  `created_at` int(11) NOT NULL,
  `updated_at` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
